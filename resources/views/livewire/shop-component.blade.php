                ...
                <div class="row">
                    <div class="col-lg-9">
                                ...
                                <div class="sort-by-cover mr-10">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            {{-- <li><a class="{{$page_size==5?'Active':''}}" href="#" wire:click.prevent = "changePageSize(20)">All</a></li> --}}
                                        </ul>
                                    </div>
                                </div>
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{$orderBy=='New Products'? 'active':''}}" href="#" wire:click.prevent = "changeOrder('New Products')">New Products</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row product-grid-3">
                            @php
                                $wl_items = Cart::instance('wishlist')->content()->pluck('id');
                            @endphp
                                ...
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
                                            @if ($wl_items->contains($product->id))
