                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" data-title="Stock">
                                            <div style="display:flex;">
                                                <a href="#" wire:click.prevent="increaseQty('{{$item->rowId}}')"><i class="fi-rs-add"></i></a>
                                                <span class="qty-val" style="margin:0 20px;"> {{$item->qty}} </span>
                                                <a href="#" wire:click.prevent="decreaseQty('{{$item->rowId}}')"><i class="fi-rs-minus"></i></a>
                                            </div>
                                            {{-- <div class="detail-qty border radius  m-auto">
                                                <a href="#" class="qty-down" wire:click.prevent="increaseQty('{{$item->rowId}}')"><i class="fi-rs-angle-small-down"></i></a>
                                        ...
                                        <td class="action" data-title="Remove"><a href="#" class="text-muted" wire:click.prevent = "remove('{{$item->rowId}}')"><i class="fi-rs-trash"></i></a></td>
                                    </tr>
                                    @endforeach
                                <tr>
